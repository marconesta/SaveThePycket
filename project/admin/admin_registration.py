...
class AdminManager(): # create a user manager class that registers the user in the resource catalog 
...
if __name__ == '__main__':
    user_manager = AdminManager("admin_settings.json", "service_catalog_settings.json")
